...
local weatherOrder = {
    {name = "CLEAR",        rainLevel=0.0, minutes=5},
    {name = "EXTRASUNNY",   rainLevel=0.0, minutes=2},
    {name = "NEUTRAL",      rainLevel=0.0, minutes=5},
    {name = "CLOUDS",       rainLevel=0.0, minutes=5},
    {name = "RAIN",         rainLevel=0.3, minutes=5},
    {name = "RAIN",         rainLevel=0.5, minutes=5},
    {name = "RAIN",         rainLevel=0.7, minutes=5},
    {name = "RAIN",         rainLevel=0.7, minutes=5},
    {name = "THUNDER",      rainLevel=1.0, minutes=5},
    {name = "RAIN",         rainLevel=0.2, minutes=5},
    {name = "CLEARING",     rainLevel=0.1, minutes=5},
    {name = "CLEARING",     rainLevel=0.0, minutes=5},
    {name = "FOGGY",        rainLevel=0.0, minutes=5},
    {name = "CLOUDS",       rainLevel=0.0, minutes=5},
    {name = "NEUTRAL",      rainLevel=0.0, minutes=5},
    {name = "CLEAR",        rainLevel=0.0, minutes=5},
    {name = "EXTRASUNNY",   rainLevel=0.0, minutes=1},
}
